		...
		<>
			...
			<Wrapper className="text-center mt-24 flex flex-col justify-center">
				<div className="w-full h-full">
					<div className='text-WhiteGray font-medium uppercase text-sm text-center'>- Only the best</div>

					<div className='font-semibold text-3xl mt-4 lg:mb-16 mb-8'>Our Satisfied Clients All Around The Globe</div>
